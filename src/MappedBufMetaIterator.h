...
public:
    ...
    void addSegment(std::shared_ptr<MappedEventBuffer>);
    void removeSegment(std::shared_ptr<MappedEventBuffer>);
     ...
     */
    void resetIteratorForSegment(std::shared_ptr<MappedEventBuffer> s, bool immediate);
    ...
    // For debugging.
    std::set<std::shared_ptr<MappedEventBuffer> > getSegments() const { return m_segments; }
...
private:
    ...
    */
    ...
    typedef std::set<std::shared_ptr<MappedEventBuffer> > MappedSegments;
