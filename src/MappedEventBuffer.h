...
public:
    ...
    {
    public:
        iterator(std::shared_ptr<MappedEventBuffer> s);
        ...
        std::shared_ptr<MappedEventBuffer> getSegment() { return m_s; }
        /// Access to the segment the iterator is connected to.
        std::shared_ptr<const MappedEventBuffer> getSegment() const { return m_s; }
    ...
    protected:
        ...
        std::shared_ptr<MappedEventBuffer> m_s;
