...
public:
    ...
    void segmentAdded(const Composition *, Segment *) ;
    ...
    void segmentEventsTimingChanged(const Composition *, Segment *, timeT delay, RealTime rtDelay) ;
    void segmentTransposeChanged(const Composition *, Segment *, int transpose) ;
    void segmentTrackChanged(const Composition *, Segment *, TrackId id) ;
    void segmentEndMarkerChanged(const Composition *, Segment *, bool) ;
    void endMarkerTimeChanged(const Composition *, bool shorten) ;
    void tracksAdded(const Composition *, std::vector<TrackId> &/*trackIds*/) ;
    void trackChanged(const Composition *, Track *) ;
    void tracksDeleted(const Composition *, std::vector<TrackId> &/*trackIds*/) ;
    void timeSignatureChanged(const Composition *) ;
    void metronomeChanged(const Composition *) ;
    void selectedTrackChanged(const Composition *) ;
    void tempoChanged(const Composition *) ;
...
public:
    std::shared_ptr<CompositionMapper> m_compositionMapper;  // owned
    std::shared_ptr<TempoSegmentMapper> m_tempoSegmentMapper;  // owned
    std::shared_ptr<TimeSigSegmentMapper> m_timeSigSegmentMapper;  // owned
    ...
    std::shared_ptr<MetronomeMapper> m_metronomeMapper;  // owned
